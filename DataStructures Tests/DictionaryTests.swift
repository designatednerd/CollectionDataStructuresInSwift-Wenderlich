...
class DictionaryTests: PerformanceTestingCase {
    ...
    func createDictionary(manipulator: DictionaryManipulator) {
        self.measureBlock() {
    ...
    func addOneEntry(manipulator: DictionaryManipulator) {
    ...
    func addFiveEntries(manipulator: DictionaryManipulator) {
        manipulator.setupWithEntryCount(count)
        measureBlock() {
    ...
    func addTenEntries(manipulator: DictionaryManipulator) {
        manipulator.setupWithEntryCount(count)
        measureBlock() {
    ...
    func removeOneEntry(manipulator: DictionaryManipulator) {
        manipulator.setupWithEntryCount(count)
        measureBlock() {
    ...
    func removeFiveEntries(manipulator: DictionaryManipulator) {
        manipulator.setupWithEntryCount(count)
        self.measureBlock() {
    ...
    func removeTenEntries(manipulator: DictionaryManipulator) {
        manipulator.setupWithEntryCount(count)
        measureBlock() {
    ...
    func lookupOneEntry(manipulator: DictionaryManipulator) {
        manipulator.setupWithEntryCount(count)
        measureBlock() {
    ...
    func lookupTenEntries(manipulator: DictionaryManipulator) {
        manipulator.setupWithEntryCount(count)
        measureBlock() {
